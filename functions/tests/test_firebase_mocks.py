...
from functions.routers.content_router import router as content_router, get_animal_by_id
...
async def test_get_animal_by_id_success():
    ...
    import functions.routers.content_router
    old_get_firestore = functions.routers.content_router.get_firestore
    functions.routers.content_router.get_firestore = lambda: db_mock
    ...
    try:
        ...
        functions.routers.content_router.get_firestore = old_get_firestore
