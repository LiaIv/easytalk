...
from functions.routers.content_router import AnimalContent, SentenceContent # Импортируем модели
from functions.shared.auth import get_current_user_id

CONTENT_ROUTER_FIRESTORE_PATH = "functions.routers.content_router.get_firestore"
