...
from functions.shared.firebase_client import initialize_firebase

# Импорт роутеров
from functions.routers.profile_router import router as profile_router
from functions.routers.session_router import router as session_router
from functions.routers.progress_router import router as progress_router
from functions.routers.content_router import router as content_router
